...
import { toggleMode, toggleSideBar } from "@/state";
...
const Navbar = () => {
  ...
  function toggleDarkMode() {
    dispatch(toggleMode(!isDarkMode));
  }
  return (
    <div className="flex justify-between items-center w-full mb-7">
      ...
      <div className="flex justify-between items-center gap-5">
        <button className="px-3 py-3 bg-gray-100 rounded-full hover:bg-blue-100">
          <Menu
            onClick={() => dispatch(toggleSideBar(!isMenuOpened))}
            className="w-4 h-4"
          />
        </button>
      ...
      <div className="flex justify-between items-center gap-5">
        <div className="hidden md:flex justify-between items-center gap-5">
          ...
          <div className="flex items-center gap-3 cursor-pointer">
            ...
            /> */}
            <span className="font-semibold">Sourabh Yalagod</span>
          </div>
        </div>
        <Link href="/settings">
